...
public class ProductController {
    ...
    ProductCreated create(@Valid @RequestBody NewProduct newProduct) {
    ...
    @PatchMapping("/{id}")
    ProductUpdated update(@Valid @RequestBody PatchProduct patchProduct, @PathVariable String id) {
        productService.patch(patchProduct, id);
        return new ProductUpdated();
    }

    @DeleteMapping("/{id}")
    ProductDeleted delete(@PathVariable String id) {
